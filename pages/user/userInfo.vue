		...
		<view class="warp">
			...
			<u-form labelPosition="left" label-width="70" :model="form" ref="uForm">
				...
				<u-form-item label="原密码" borderBottom>
					<u-input v-model="form.pass3" type="password" placeholder="请输入密码"/>
				</u-form-item>
				<u-form-item label="新密码" borderBottom>
					<u-input v-model="form.pass2" type="password" placeholder="请输入新密码"/>
				</u-form-item>
				<u-form-item label="确认密码" borderBottom>
					<u-input v-model="form.pass1" type="password" placeholder="请确认密码"/>
				</u-form-item>
			</u-form>
			<view class="buttonBox">
				<u-button type="primary" text="提交" @tap="sub()"></u-button>
			</view>
		</view>
